...
This folder contains the scripts used for extracting text from Spanish-language web sites, either from the HTML or from downloaded PDFs. Two sample scripts are included as well as instructions for running the script on a website.
